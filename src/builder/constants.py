# nanocrystal_builder/constants.py
...
COV_RAD = {
    ...
    "In": 1.44,  # (kept your value; Cordero: 1.42)
    "Sn": 1.39, "Sb": 1.39, "Te": 1.38, "I": 1.39, "Xe": 1.40,
    # Cs–Rn (incl. lanthanides)
    "Cs": 2.44, "Ba": 2.15,
    ...
    "Hg": 1.32, "Tl": 1.45, "Pb": 1.46, "Bi": 1.48, "Po": 1.40, "At": 1.50, "Rn": 1.50,
    # Fr–Cm (actinides commonly needed)
    "Fr": 2.60, "Ra": 2.21,
